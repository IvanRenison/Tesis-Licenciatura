...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Funciona para un cuerpo arbitrario
    \item Para los racionales usa la libraría FLINT para las matrices
    \item Incluye representación de cofactores (``\textit{reconstrucción de la respuesta}'')
...
\begin{frame}
  \frametitle{Comparación}
  Paralelismo viendo la parte de más abajo
  \noindent \begin{tikzpicture}
    \begin{axis}[
        ybar = 0.5pt, % Tipo de gráfico: barras verticales
        width = \textwidth,
