...
\noindent \begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture} % Agregar los tri


Acá se puede ver que aumentar los hilos hace que sea un poco más rápido, pero muy poco. Esto tiene sentido por lo de que solo la parte de agregar ambigüedades está paralelizada.
% Agregar los benchmarks de la reconstrucción
