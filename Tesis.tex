...
Hay otras dos optimizaciones mas que se pueden hacer a este algoritmo, una es para descartar algunas ambigüedades sin tener que reducirlas y la otra es para ir sacando algunos polinomios de la base. Ambas optimizaciones están explicadas en \cite{thesis:Hof20} y no se van a explicar acá.
...
Lo de las optimizaciones se explica mas adelante en la sección …. % Agregar referencia cuando esté
...
% Quizas se podría decir que el motivo por el cual lo de FLINT es como es probablemente sea porque es una librería de C?
