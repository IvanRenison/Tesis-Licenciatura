...
Esta tesis presenta una implementación en \cpp para el calculo de las llamadas bases de Grobner no conmutativas. Ya existían previamente algunas implementaciones de dicho cálculo, pero en esta tesis se presenta una que es la primera en \cpp y además incluye un poquito de paralelismo.
