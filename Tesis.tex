...
La librería también tiene un Makefile con el que se pueden compilar los archivos del directorio \path{mains} y correr los tests. Este Makefile puede servir de ejemplo de como se compila un archivo que usa la librería.
