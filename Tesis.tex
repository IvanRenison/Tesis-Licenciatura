...
\[ ∃n ∈ ℕ, g_1, …, g_n ∈ G, f_1, …, f_n, f'_1, …, f'_n ∈ K⟨X⟩ : f = ∑_{i = 1}^n f_i g_i f'_i \]
...
\begin{definition}\label{def:ideal}
  ...
  \[ (G) = \{∑_{i = 1}^n c_i g_i c_i' : n ∈ ℕ, g_1, …, g_n ∈ G, c_1, …, c_n, c_1', …, c_n' ∈ R\} \]
\end{definition}
...
\begin{theorem}[Caracterización de las formas normales de $→$]
  ...
  \[ f\text{ está en forma normal con respecto a} →_{≤, G} ⇔ ∄g ∈ G, m ∈ \sop(f) : \lm(g) | m \]
\end{theorem}
\begin{proof}
...
\begin{definition}
  Sean $m, m', a, b, c, d ∈ ⟨X⟩$
  \[ (a, b, c, d, m, m')\text{ es una ambigüedad} ⇔ amb = cm'd ∧ |a|, |b| < |m'| ∧ |c|, |d| < |m| \]
...
\begin{proof}[Demostración del \cref{thm:Buchberger correctitud}]
  ...
  \[ ∀f ∈ (G) - \{0\} : ∃g_1, …, g_n ∈ \B_{e_≤}^k(G), a_1, …, a_n, b_1, …, b_n ∈ ⟨X⟩ : \lm(a_i g_i b_i) ≤ \lm(f) : f = ∑_{i = 1}^n a_i g_i b_i \]
