...
Los tests que tienen benchmarks son todos tests que usan los mains de la carpeta \texttt{mains} y mains hechos en python con \texttt{operator\_gb} y son corridos con distintas entradas desde un archivo de python. A los tiempos se los mide desde el programa de python, así que incluyen en tiempo hasta que se inicializa el programa y lee la entrada y el tiempo de la impresión de la salida, pero como son siempre entradas y salidas relativamente chicas eso no debería ser problema.
...
Los Nichols que están porque son de interés para Cristian Vay, el director de esta tesis y su descripción está en \cite{web:Nichols}. Los tri que están porque \cite{thesis:Hof20} los usa, y el los sacó del Teorema 2.12 de \cite{book:class-tri}, y los trit son directamente sacados de la Proposición 1.9 de \cite{book:class-tri}.
...
El tests que usa los distintos algoritmos para calcular bases de Gröbner de conjuntos generadores que se sabe que tienen bases de Gröbner finitas incluye mediciones de los tiempos y por supuesto usa los casos que vimos recién.
...
El test que prueba que de lo mismo correr con distintas cantidades de hilos también usa los mismos casos y mide los tiempos. En el siguente gráfico se pueden ver los resultados.
...
Acá se puede ver que aumentar los hilos hace que sea un poco más rápido, pero muy poco. Tiene sentido igual que sea muy poco porque lo de que solo la parte de agregar ambigüedades está paralelizada.
...
Estos datos igualmente mucho no sirven, porque como buscan por una cierta cantidad de pasos, y los pasos son cosas distintas en los distintos algoritmos, no se puede comparar. En particular, un paso de F4 puede corresponder a muchos pasos de Buch.
