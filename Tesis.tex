...
El tests que usa los distintos algoritmos para calcular bases de Gröbner de conjuntos generadores que se sabe que tienen bases de Gröbner finitas incluye mediciones de los tiempos. Los casos que se usan acá son se dos familias, los \texttt{tri} que están porque \cite{thesis:Hof20} los usa y los \texttt{Nichols} que están porque son de interés para Cristian Vay, el director de esta tesis. La descripción de los Nichols está en \cite{web:Nichols}.
...
\noindent \begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot coordinates {(Nichols2, 0.00) (Nichols3, 0.00) (tri1, 0.26) (tri2, 6.00) (tri3, 0.02) (tri4, 0.04) (tri5, 0.01) (tri6, 6.54) (tri7, 33.36) (tri8, 0.09) (tri9, 0.00) (tri10, 0.01) (tri11, 0.03) (tri12, 3.27) (tri13, 0.01)};
    \addplot coordinates {(Nichols2, 0.01) (Nichols3, 0.01) (tri1, 0.08) (tri2, 0.30) (tri3, 0.26) (tri4, 0.07) (tri5, 0.02) (tri6, 1.79) (tri7, 1.85) (tri8, 0.06) (tri9, 0.01) (tri10, 0.01) (tri11, 0.02) (tri12, 0.21) (tri13, 0.01)};
    \addplot coordinates {(Nichols2, 0.82) (Nichols3, 0.81) (tri1, 0.98) (tri2, 1.19) (tri3, 0.92) (tri4, 0.96) (tri5, 0.89) (tri6, 1.30) (tri7, 1.48) (tri8, 0.94) (tri9, 0.84) (tri10, 0.86) (tri11, 0.90) (tri12, 1.04) (tri13, 0.85)};
  \end{axis}
\end{tikzpicture}
