...
%   \item Alvaro Roy Schachner que me ayudó con cosas de Linux y la computadora Atom y que además cuando miró la tesis hizo algunas sugerencias.
...
El \cref{problem:principal} así planteado no es decidible, pero sí es semi-decidible. Esto significa que no hay un algoritmo que dice si vale la expresión o no, pero sí hay un algoritmo que en los casos en los que sí vale termina diciendo que sí y los casos en los que no vale puede no terminar.
