...
En este trabajo se aborda el calculo de algo que se llama bases de Gröbner no conmutativas, que es algo que tiene que ver con los que se llaman polinomios no conmutativos. En los primeros capítulos se da toda la explicación matemática del tema, de forma que la tesis es autocontenida y en los siguientes capítulos se explica una librería de \cpp que se hizo que implementa los algoritmos y demás cosas explicadas en la explicación matemática.
% Ni idea de si esto está bien
...
% La idea de esta sección es listar a quienes ayudaron en algo, pero no se bien todavía como la voy a redactar

% Tengo que poner:

% Cristian y Miguel
% Lu M que la leyó e hizo bastantes se sugerencias
% Álvaro que me ayudó con atom un par de veces y también hizo algunas sugerencias cuando miró un poco la tesis
% Algo de que usé atom
% A Nico y Agustín García si hacen sugerencias
...
% Ni idea de que podría fallar, pero porque alguien querría usar otra cosa? O sea, el motivo para hacerlo genérico es por si alguien lo quiere usar para más de 256 variables, no para hacer def:orden lexicográfico por grado
