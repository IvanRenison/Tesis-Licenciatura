...
El seudocódigo se puede entender como funciona analizandolo en detalle, pero lo importante es saber que calcula los polinomios que va a hacer falta que sean las filas de la matriz, y no importa demasiado entender como funciona por dentro. % ¿Está "analizandolo" bien escrito?
...
La librería también tiene un Makefile con el que se pueden compilar los mains del directorio \path{mains} y correr los tests. Este Makefile puede servir de ejemplo de como se compila un archivo que usa la librería.
