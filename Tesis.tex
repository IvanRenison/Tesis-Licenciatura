...
\begin{theorem}\label{thm:Buchberger correctitud}
  ...
  \begin{enumerate}
    \item $\B_{e_≤}(G)$ es una base de Gröbner de $(G)$.\label{thm:Buchberger correctitud:item:1} % TODO: Hacer esto en todos lados
...
\begin{proof}[Demostración del \cref{thm:Buchberger correctitud}]
  ...
  Tenemos que probar que $\B_{e_≤}^k(G)$ es una base de Gröbner de $(G)$. Por (5) del \cref{thm:equivalencias de base de Gröbner} alcanza con probar:
...
% Agregar de probar librerías de aritmética modular
