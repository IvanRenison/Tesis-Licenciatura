...
\end{theorem}
\begin{proof}
Por definición de las reducciones tenemos que (a) $⇒$ (b) $⇒$ (c), por lo cual alcanza con probar (a). Para ello supongamos el antecedente $f →_{≤, a, g, b} f'$
...
% Falta probar la otra inclusión
\end{description}
\end{proof}
