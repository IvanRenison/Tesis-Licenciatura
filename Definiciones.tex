...
La parte de implementar en C++ esos algoritmos se logró, pero hay una optimización que ayuda bastante y no se hizo. La parte de hacerlo correr en paralelo se hizo, pero solo para una parte y para la parte de la optimización que no se hizo tampoco se hizo nada en paralelo. Hacer esa optimización.

\chapter{Definiciones preliminares}

En este capitulo se explican los conceptos matemáticos necesarios para entender el resto del trabajo.
